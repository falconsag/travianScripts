// ==UserScript==
// @name           Sajat Resource bar plus
// @namespace      http://userscripts.org/scripts/show/75431
// @description    Shows travian resources (for Travian Legends and Travian Fire and Sand)
...
(function () {
    ...
    var langs = ['auto','English (en)','???? (ar)','????????? (bg)','Bosanski (bs)','Deutsch (de)','???????? (el)','Espanol (es)','????? (fa)','Français (fr)','Hrvatski (hr)','Magyar (hu)','Italiano (it)','Nederlands (nl)','Polski (pl)','Portugues (pt)','Românã (ro)','??????? (ru)','?????? (sr)','Svenska (sv)','Türkçe (tr)','?????????? (ua)','Ti?ng Vi?t (vi)','?? (zh)'];
    ...
    DICT = {
        en: {
            ...
            servertypeh : "Server types: Travian Legends, Travian Fire and Sand",
            servertypeo : ['update','Fire and Sand','Legends'],
        ...
        hu: { // Hungarian language. thx mrzed :)
            ...
            bigicon : "Gyülekezõtér ikon megjelenítése",
            opennote : "Jegyzetek automatikus megnyitása",
            resbar : "Nyersanyagkijelzõ",
            showres : "Nyersanyagkijelzõ külön ablakban",
            redbl : "piros (órában)",
            yellowbl: "sárga (órában)",
            marketpl : "Piactér",
            mfilter : "szûrõ",
            mfiltero : ['nincs','csak arány','csak szûrõ','teljes'],
            rpandmp : "Gyülekezõtér és piactér",
            incomres : "Információ az érkezõ nyersanyagokról",
     ...
     ar: { // Arabic, thx ww_start_t
        ...
        fr: { // French translation , thx azukae09
            ...
            notes : "notes",
            res90 : "Ressources a % de la capacité",
            refresh : "rafraichir",
            warehouse : "Entrepôt",
            ...
            buildand : "Montrer le compte a rebours pour les constructions et les attaques",
            ...
            showres : "Montrer la barre des ressources dans une fenetre",
            ...
            showlso : ['Non','Oui','Dans une fenetre'],
            ...
            adetecth : "Fait des requetes masquées au serveur, ce qui viole les regles et peut ocasionner une sanction",
            ...
            bidinc : "Incrément d'enchere",
            bidinch : 'Pour les encheres dans travian4',
            savedelallh : 'Etes vous sur d\'effacer les données sauvegardées (y compris les liens et le second nom)',
            notification : "Notification apres construction",
            method : "Méthode",
        ...
        hr: { // Croatian translation, thx semiRocket
            ...
            consnegat : "Potrošnja hrane u naselju je negativna. Koliko minuta želite prièuve?",
            bmove : "Premještanje graðevina",
            neighbors : "susjedi",
            // settings
            none : 'Ništa',
            auto : "automatsko",
            ...
            crannyh : 'Normalno 80, 70 za klasiène pljaèke ili artefakt',
            builtin : "Ugraðeni alati",
            ...
            normal : "Normalno",
            banalyze : "Ugraðeni analizator bitke",
            cropfind : "Ugraðena tražilica žitnih (crop) polja",
            adetect : "Detektiranje napada",
            adetecto : ['Iskljuèeno','Bez zamrzavanja','Ukljuèeno'],
            adetecth : "Radi skrivene zahtjeve prema poslužitelju kršeæi pravila. Može dovesti do kazni.",
            ...
            buildands : ['Iskljuèeno','Ukljuèeno','Prostrano'],
            ...
            addvtableo : ['Iskljuèeno','Ukljuèeno','Zalijepljeno'],
            opennote : "Automatski otvori zabilješke",
            notesize : "Velièina prozora za zabilješke",
            ...
            marketpl : "Tržnica",
            mfilter : "Filter",
            mfiltero : ['Iskljuèeno','Samo omjer','Samo filter','Potpuno'],
            npcsum : "Sažetak za NPC",
            npcsumh : 'Prikaz u tržnici i zgradama',
            bidinc : "Poveæanje ponude",
            bidinch : 'Koristi se za aukcije (Travian 4)',
            show3x : "Predviðanje kretanja kod 2x i 3x",
            ...
            incomres : "Informacije o dolazeæim resursima",
            incomreso : ['Iskljuèeno','Ukljuèeno','S kratkim pregledom','WW mod'],
            troopsI : "Informacije o trupama",
            troopsIo : ['Iskljuèeno','Ukljuèeno','Skeniraj upute'],
            ...
            showlso : ['Iskljuèeno','Ukljuèeno','U zasebnom prozoru'],
            savedls : "Spremljene poveznice",
            savedd : "Pohranjeni podaci",
            saveddh : 'Ukljuèuje linkove i druge nazive naselja. Korisno ako se raèun briše ili ne koristi na Vašem raèunalu.',
            savedelall : "Izbriši sve pohranjene podatke",
            savedelallh : 'Jeste li sigurni da želite izbrisati sve pohranjene podatke, ukljuèujuæi linkove i druge nazive naselja?',
        ...
        pt: { // Portuguese language, thx Kendra
            ...
            racelist : ['Romanos','Teutoes','Gauleses','Nature','Natars','Egyptians','Huns','detect'],
            ...
            builtinh : 'Para equilibrar a produçao: a cor Vermelha - recursos que mais precisam; Verde - recursos que menos precisam',
            normalize : 'Equilibrar a produçao',
            normal : "normal",
            ...
            adetecth : "Esta opçao utiliza açoes ocultas no servidor, violando as regras. Poderá levar a puniçao do jogo.",
            adetectt : "periodo de detectar ataques",
            buildhint : "Dicas de Construçao",
            onallp : "Todas as páginas",
            buildand : "Mostrar construçao em contagem regressiva e atacar",
            ...
            openoview : "Abrir visao detalhada das aldeias",
            ...
            bidinc : "Valor aumentado automaticamente no leilao",
            bidinch : 'Só disponivel para a versao Travian 4',
            ...
            incomres : "informaçoes de recursos recebidos",
            incomreso : ['desligado','ligado','com sumário','Modo WW'],
            troopsI : "Informaçoes sobre as tropas",
            troopsIo : ['Desligado','Ligado','Actualizado'],
            defRP : "Açao pré-definida no envio de tropas",
            showls : "Mostrar links",
            showAsSN : "Usar links como segundo nome",
            showlso : ['desligado','ligado','na janela'],
            savedls : "Links salvos",
            savedd : "Salvar dados",
            saveddh : 'incluindo links e segundo nome. Se uma conta excluída, ou nao o seu computador.',
            ...
            youlang : "Seu idioma",
            notifi : "Notificaçoes",
            notification : "notificaçao após a construçao",
            method : "Método",
            audiourl : "Link do ficheiro de audio",
            audiotest : "Testar Audio",
            colorCustomize : "Opçoes de Cores",
            colorHint : "Deixe em branco para a cor padrao",
            color0 : "Pronto para evoluir",
            color1 : "Evoluir fazendo NPC",
            color2 : "Nao é possível evoluir <br/>(Falta de recursos)",
            color3 : "Nao é possível evoluir <br/>(Nao tem armazem e/ou celeiro suficiente)",
        ...
        ro: { // Romanian language, thx bubulu
            ...
            archive : "Arhivã",
            arena : "Nivel arenã",
            addcur : "adaugã curent",
            del : "?terge",
            edit : "editeazã",
            unpin : "anuleazã fixarea",
            pin : "fixeazã",
            total : "Total",
            noplace : "nu este loc!",
            hunger : "foame",
            ...
            consnegat : "Consumul de hranã în acest sat este negativ. Pentru câte minute este nevoie de rezervã de hranã?",
            bmove : "Mutã clãdirile",
            neighbors : "vecini",
            // settings
            none : 'None',
            auto : "auto",
            ...
            servertypeh : "Tipuri de servere: Travian Legends, Travian Fire and Sand",
            servertypeo : ['update','Fire and Sand','Legends'],
            speedart : "Artefact de vitezã",
            racelist : ['Romani','Barbari','Daci','Natura','Natari','Egipteni','Huni','detectazã'],
            cranny : "Culoarea galbenã la beci (în procente)",
            crannyh : 'normal 80%, 70% pentru server clasic',
            builtin : "Unelte incluse",
            builtinh : 'pentru normalizarea produc?iei: culoarea ro?ie - cea mai mare nevoie de resurse, verde - cea mai micã nevoie de resurse',
            normalize : 'Normalizarea produc?iei',
            normal : "normal",
            banalyze : "Analizor de luptã integrat",
            cropfind : "Cãutãtor de c15 integrat",
            adetect : "Detector de atacuri",
            adetecto : ['off','fãrã blocare','on'],
            adetecth : "face cereri ascunse la server, care încalcã regulile. poate duce la penalizare.",
            adetectt : "Perioada de detectare a atacurilor",
            buildhint : "Sfaturi pentru construc?ii (culori)",
            onallp : "Toate paginile",
            buildand : "Aratã numãrãtoarea inversã pentru construc?ii ?i atacuri",
            buildandh : 'în lista satelor',
            buildands : ['off','on','detaliat'],
            sendres : "Aratã icoana &laquo;trimite resurse/trupe&raquo;",
            sendmess : "Aratã icoana &laquo;trimite mesaj&raquo;",
            analyzer : "Analizor server",
            bigicon : "Aratã icoana pentru Adunare",
            addvtable : "Aratã lista suplimentarã cu sate",
            addvtableo : ['off','on','fix'],
            opennote : "Deschide fereastra de noti?e automat",
            notesize : "Dimensiunea ferestrei de noti?e",
            openoview : "Deschide fereastra cu privirea generalã automat",
            resbar : "Bara de resurse",
            showres : "Afi?eazã bara de resurse în fereastrã",
            redbl : "ro?u (în ore)",
            ...
            npcsumh : 'la târg ?i la clãdiri',
            bidinc : "Mãre?te oferta licita?iilor cu (în argin?i)",
            ...
            defRP : "Ac?iune implicitã la adunare",
            showls : "Aratã link-uri",
            showAsSN : "Folosi?i link-urile cu numele secundar",
            showlso : ['off','on','în fereastrã'],
            ...
            savedelallh : 'E?ti sigur cã vrei sã ?tergi toate datele, inclusiv link-urile ?i numele secundare ale satelor?',
            scrlang : "Limbã script",
            youlang : "Limba browser-ului",
            notifi : "Notificãri",
            notification : "notificare dupã construc?ie",
            method : "Metoda",
            audiourl : "URL of audio file",
            audiotest : "Test audio",
            colorCustomize : "Op?iuni culori",
            colorHint : "lasã gol pentru culorile implicite",
            color0 : "Upgrade disponibil",
            color1 : "Upgrade via NPC",
            color2 : "Upgrade-ul nu este posibil <br/>(nu sunt suficiente resurse)",
            color3 : "Upgrade-ul nu este posibil <br/>(grânarele / hambarele nu au capacitatea suficientã)",
            color4 : "Nivel final"
        },
        ...
        pl: { // Polish translation, thx aren
            ...
            info : "Informacja",
            yourrace : "Twoja rasa",
            speedart : "Prêdkoœæ artefaktu",
            racelist : ['Rzymianie','Germanie','Galowie','Nature','Natars','Egyptians','Huns','detect'],
            cranny : "¿ó³ty poziom kryjówki (procent)",
            crannyh : 'normalny 80, 70 do grabie¿y na klasycznym lub artefakcie',
            builtin : "Wbudowane narzêdzia",
            builtinh : 'dla normalizacji produkcji: kolor czerwony - najwiêcej œrodków potrzeba, zielony - potrzeba mniej zasobów',
            ...
            buildandh : 'Na liœcie osad',
            sendres : "Pokaz &laquo;wyœlij surowce/jednostki&raquo; ikony",
            sendmess : "Pokaz &laquo;wyœlij wiadomoœæ&raquo; ikony",
            analyzer : "World analyzer",
            ...
            troopsIo : ['off','on','scan help'],
            defRP : "domyœlna akcja dla Miejsca zbiórki",
            showls : "Pokaz linki",
            showlso : ['off','on','w oknie'],
            savedls : "zapisane linki",
            savedd : "zapisane dane",
            saveddh : 'w tym Linki i Druga nazwa. Jeœli konto usuniête, albo nie twój komputer.',
            savedelall : "usun¹æ wszystkie zapisane dane",
            savedelallh : 'Czy na pewno chcesz usun¹æ wszystkie dane, w tym linki i druga nazwe?',
            scrlang : "Jêzyk skryptu",
            youlang : "twój jêzyk",
            notifi : "powiadomienie",
            notification : "powiadomienia po zakoñczeniu budowy",
            method : "metoda",
        ...
        sv:{ // Swedish translation, thx Dragon from the future
            ...
            cranny : "Gul niva pa grotta (procent)",
            crannyh : "Normal 80, 70 för klssisk eller artefakt-plundrare",
            builtin : "Inbyggda hjälpmedel",
            builtinh : "För att aterställa produktionen: röd färg - Behövs mest resurser, green - behövs mindre resurser",
            normalize : "Aterställ produktionen",
            normal : "normal",
            ...
            sendres : "Visa &laquo;sänd ravaror/trupper&raquo; ikoner",
            ...
            resbar : "Ravaror-fält",
            showres : "Visa ravaror-fältet i ett eget fönster",
            redbl : "röd (i timmar)",
            ...
            incomres : "ikommande ravaro-info",
            incomreso : ['av','pa','med sammanfattning','Världsunder'],
            troppsl : "Information om soldaterna",
            troopslo : ['av','pa','i fönster'],
            defRP : "Förvald attacktyp pa samlingsplats",
            showls : "Visa länkar",
            showlso : ['av','pa','i fönster'],
            ...
            savedelallh : 'Är du säker pa att du vill radera all data, länkar och andra namnpa byar?',
            scrlang : "Script sprak",
            youlang : "ditt sprak",
            notifi : "notifikation",
        ...
        it: { // Italian translation , Dragonflame
            ...
            notes : "Blocco note",
            res90 : "Risorse a % della capacita",
            refresh : "Aggiorna",
            warehouse : "Magazzino",
            resources : "Risorse",
            troops : "Truppe",
            ...
            auto : "auto",
            info : "Informazioni",
            yourrace : "La tua Tribu:",
            speedart : "Artefatto velocita",
            racelist : ['Romani','Teutoni','Galli','Nature','Natars','Egyptians','Huns','detect'],
            cranny : "Livello giallo della capacita del deposito segreto (%)",
            crannyh : 'Normalmente 80; Per il server classico o per artefatto del Ladro 70;',
            builtin : "Strumenti Integrati",
            builtinh : 'Per la produzione ottimizzata: Rosso = Servono piu risorse; Verde = servono meno risorse;',
            ...
            incomreso : ['No','Si','Con risultati','Modalita Meraviglia'],
            ...
            savedls : "Salva link",
            savedd : "Salva Dati",
            saveddh : 'Incluso Links e Secondo nome. Se un Account viene cancellato, o non e il tuo computer.',
        ...
        es: {// Spanish translation. neonsp
            ...
            notesize : "Tamano de la ventana de notas",
        ...
        tr: { // Turkish language. xpugur
            ...
            troops : "Askerler",
            links : "Baglantilar",
            linkname : "baglanti adi",
            linkdel : "baglantiyi sil",
            name2 : "ikinci ad",
            archive : "Arºiv",
            arena : "Turnuva alani",
            addcur : "mevcutu ekle",
            ...
            duration : "süre",
            deficit : "eksiklik",
            aclock : "Alarm saati\nhh:mm:ss , hh:mm , mm (ºuandan itibaren)",
            consnegat : "Bu köyde tüketim eksilerde. Kaç dakika gerekiyor rezervlerin dolmasi için?",
            bmove : "Binalari taºi",
            // settings
            none : "Yok",
            auto : "otomatik",
            ...
            yourrace : "Irkin",
            speedart : "Hiz eseri",
            racelist : ['Romanlilar','Cermenler','Galyalilar','Nature','Natars','Egyptians','Huns','detect'],
            cranny : "siginak sari seviyesi (yüzde)",
            crannyh : 'normal 80, klasik veya eser yagmasi için 70 ',
            builtin : "Entegre araçlar",
            builtinh : 'Üretimi normalleºtirmek için: kirmizi renk - en gerekli kaynak, yeºil - en az gerekli kaynak',
            normalize : 'Üretimi normalleºtirmek için',
            normal : "normal",
            banalyze : "Dahili savaº analizcisi",
            cropfind : "Dahili tarla bulucu",
            adetect : "Saldirilari algila",
            adetecto : ['kapa','w/o dondur','aç'],
            adetecth : "Server a gizli istekler gönderir, kural ihlalidir. Ceza gelebilir.",
            adetectt : "saldiri algilama zaman araliklari",
            buildhint : "inºaat ipuçlari",
            onallp : "Tüm sayfalar",
            buildand : "inºaat gerisayimini ve saldirilari göster",
            buildandh : 'Köy listelerinde',
            sendres : "iºaretleri göster: ?send resource/troops? ",
            sendmess : "iºaretleri göster: ?send message? ",
            analyzer : "Dünya analizcisi",
            bigicon : "Git-gel noktasi simgesi göster",
            addvtable : "Ek köy tablosunu göster",
            addvtableo : ['kapa','aç','sabitle'],
            opennote : "Otomatik olarak notlari aç",
            notesize : "Notlar için pencere boyutu",
            openoview : "Otomatik olarak köylerin genel görüºünü aç",
            resbar : "Kaynaklar çubugu",
            showres : "Kaynaklar çubugunu pencerede göster",
            redbl : "kirmizi (saat olarak)",
            yellowbl: "sari (saat olarak)",
            marketpl : "Market",
            mfilter : "filtre",
            mfiltero : ['kapa','sadece oran','sadece filtre','dolu'],
            npcsum : "NPC için özet",
            npcsumh : 'binalarda ve markette',
            bidinc : "teklif arttir",
            bidinch : 'travian4 açik-arttirmalari için',
            show3x : "yanliº veri gösterebilir",
            show3xh : '3x ve 2x ile gönderilen kaynak akiºini tahmin etmeye çaliº',
            rpandmp : "Marketteki git-gel noktasi",
            incomres : "gelen kaynak bilgisi",
            incomreso : ['kapa','aç','özetle','WW modu'],
            troopsI : "Askerler hakkinda bilgi",
            troopsIo : ['kapa','aç','yardim ara'],
            defRP : "git-gel noktasi için standart hareket",
            showls : "Baglantialri göster",
            showAsSN : "Baglantilari ikinci isim olarak kullan",
            showlso : ['kapa','aç','pencerede'],
            savedls : "kaydedilmiº baglantilar",
            savedd : "kaydedilmiº veriler",
            saveddh : 'baglantilar ve ikinci ismi içeren. Hesap silindiyse, yada kendi bilgisayariniz degilse.',
            savedelall : "kaydedilmiº tüm verileri sil",
            savedelallh : 'ikinci isim ve baglantilari içeren, tüm verileri silmekte emin misiniz?',
            scrlang : "Kod dili",
            youlang : "Kendi diliniz",
            notifi : "bilgilendirmeler",
            notification : "inºaattan sonra bilgilendirmeler",
            method : "method",
            audiourl : "ses dosyasinin URL si",
            audiotest : "test sesi"
        },
        vi: { // VietNamese translation by Nguy?n Duy Thanh
            ...
            cancel : "Hu? b?",
            close : "Ðóng",
            overview : "t?ng quan lang",
            svers : "Phien b?n scripts(translator thanhgola):",
            settings : "Cai ð?t",
            notes : "ghi chú",
            res90 : "Tai nguyen c?n ð? ð?y %",
            refresh : "lam tuoi",
            warehouse : "nha kho",
            resources : "Tai nguyen",
            troops : "Lính",
            links : "Lien k?t",
            linkname : "ten lien k?t",
            linkdel : "xoá lien k?t",
            name2 : "ten ph?",
            archive : "Luu tr?",
            arena : "Vo ðai",
            addcur : "them lien k?t hi?n t?i",
            del : "xoá",
            edit : "s?a",
            unpin : "g?",
            pin : "s?a",
            ...
            duration : "Th?i gian",
            deficit : "Thâm h?t",
            aclock : "Ð?ng h? báo\nhh:mm:ss , hh:mm , mm ( tính t? bây gi?)",
            consnegat : "M?c tieu th? âm. C?n bao nhieu phút ð? d? tr??",
            bmove : "D?i công trinh",
            // settings
            none : "Không",
            auto : "t? ð?ng",
            info : "Thông tin",
            ...
            racelist : ['Romans','Teutons','Gauls','Nature','Natars','Egyptians','Huns','detect'],
            cranny : "Báo mau vang khi ?ng tai nguyen ð?t (%)",
            crannyh : 'thông thu?ng la 80, 70 cho lang binh thu?ng ho?c lang có Binh ru?u c?a Dionysus',
            builtin : "Công c? công trinh",
            builtinh : 'Chu?n hoá s?n lu?ng tai nguyen: mau ð? -lo?i tai nguyen c?n nh?t, mau xanh - lo?i tai nguyen ít c?n',
            normalize : 'Chu?n hoá s?n lu?ng tai nguyen',
            normal : "chu?n",
            banalyze : "Ch?c nãng - phân tích tr?n chi?n",
            cropfind : "Ch?c nãng - tim lang nhi?u ru?ng lúa",
            adetect : "Phát hi?n t?n công",
            adetecto : ['t?t','w/o m?c ð?nh','m?'],
            adetecth : "?n các hanh vi có th? d?n ð?n hinh phát",
            adetectt : "Th?i gian phát hi?n t?n công",
            buildhint : "M?o xây d?ng",
            onallp : "T?t c? trang",
            buildand : "Hi?n th? th?i gian xây d?ng va t?n công",
            buildandh : 'Trong danh sách lang',
            sendres : "Hi?n bi?u tu?ng «G?i tai nguyen/G?i lính»",
            sendmess : "Hi?n bi?u tu?ng <<g?i>>",
            analyzer : "Phân tích th? gi?i",
            bigicon : "Hi?n bi?u tu?ng Binh tru?ng",
            addvtable : "Hi?n th? danh sách lang b? sung",
            addvtableo : ['t?t','m?','dính'],
            opennote : "T? ð?ng m? ghi chú",
            notesize : "Kích thu?c c?a s? ghi chú",
            openoview : "T? ð?ng m? t?ng quát lang",
            resbar : "Thanh tai nguyen",
            showres : "Hi?n thanh tai nguyen tren c?a s?",
            redbl : "Ð? (gi?)",
            yellowbl: "Vang (gi?)",
            marketpl : "Khu ch?",
            mfilter : "B? l?c",
            mfiltero : ['t?t','ch? t? l?','ch? b? l?c','ð?y ð?'],
            npcsum : "Tóm t?t cho NPC",
            npcsumh : 'ch? va công trinh',
            bidinc : "Tãng ð?u giá",
            bidinch : 'ð?u giá c?a travian4',
            show3x : "Có th? hi?n th? d? l?u không chính xác",
            show3xh : 'c? g?n d? ðoán các lu?n tai nguyen sever 2x va 3x ðang g?i',
            rpandmp : "Binh tru?ng va ch?",
            incomres : "Thông tin tai nguyen ðang ð?n",
            incomreso : ['t?t','m?','v?i tóm t?t','ch? ð? WW'],
            troopsI : "Thông tin v? quân ð?i",
            troopsIo : ['t?t','m?','tim tr? giúp'],
            defRP : "Hanh ð?ng m?t ð?nh khi g?i lính",
            showls : "Hi?n lien k?t",
            showAsSN : "S? d?ng lien k?t nhu ten ph?",
            showlso : ['t?t','m?','trong c?a s?'],
            savedls : "Luu lien k?t",
            savedd : "Lien k?t ða luu",
            saveddh : 'g?m lien k?t va lien k?t ph?. N?u tai kho?ng xoá ho?c ðây không ph?i máy tính c?a b?n.',
            savedelall : "xoá t?t c? d? li?u ða luu",
            savedelallh : 'b?n có ch?c mu?n xoá h?t d? li?u, bao g?m c? lien k?t va ten ph? cu? nó?',
            scrlang : "Ngôn ng? Script",
            youlang : "Ngôn ng? c?a b?n",
            notifi : "Thông báo",
            notification : "thông báo sau khi xây d?ng xong",
            method : "Phuong pháp",
            audiourl : "URL c?a t?p nh?c",
            audiotest : "Th? nh?c",
            neighbors : "Tim ki?m",
            colorCustomize : "Cai ð?t mau s?c",
            colorHint : "Ð? tr?ng ð? cho mau m?c ð?nh",
            color0 : " S?n san nân c?p ",
            color1 : "Nân c?p thông qua NPC",
            color2 : "Không th? nân c?p<br>(do không ð? tai nguyen)",
            color3 : "không th? nân c?p<br>(do nha kho/ kho lúa không ð? s?c ch?a)",
            color4 : "Hoan thanh nân c?p"
        },
        el: {// Greek translation by Tasos el malo
            ...
            yourrace : "? ???? ???",
            speedart : "???????? ???????µ????",
            racelist : ['??µ????','????????','???????','Nature','Natars','Egyptians','Huns','detect'],
            cranny : "??????? ??????? ???????? (???????)",
            crannyh : '???????? 80, 70 ??? ??????? ? ???????µ??? ?????????',
            builtin : "????µ???µ??? ????????",
            builtinh : '??? ?µ????????? ?????????: ??????? ???µ? - µ????????? ?????? ?????, ??????? - ???????? ?????? ?????',
            ...
            savedls : "????????µ???? ??????µ??",
            savedd : "????????µ??? ????µ???",
            saveddh : '??µ??????µß???µ???? ??? ??????µ?? ??? ??? ???????? ???µ????. ?? ???? ????????µ?? ?????????, ? ??? ? ??????????? ???.',
            savedelall : "???????? ???? ??? ????????µ???? ????µ????",
            savedelallh : '????? ???????? ??? ?????? ?? ?????????? ??? ?? ????µ???, ??µ??????µß???µ???? ??? ??????µ?? ??? ?? ??????? ???µ??',
            scrlang : "?????? Script",
            youlang : "? ?????? ???",
            notifi : "??????????",
            notification : "?????????? µ??? ??? ?????????",
    ...
    function getTTime(dist, speed, arena, artefact, shoes) {
        ...
        var abonus = (RB.Setup[46] == 1 ? 0.2 : 0.1); //if Travian Fire and Sand server then double the Tournament Square bonus
    ...
    function needed_show( base ) {
        function saveWantsMem ( wantsResM ) {
            ...
            //CUSTOMIZED
            var sum = RB.wantsMem[0] + RB.wantsMem[1] + RB.wantsMem[2] + RB.wantsMem[3];
            alert( noplace +"\nSaved: "+ RB.wantsMem[0] +" | "+ RB.wantsMem[1] +" | "+ RB.wantsMem[2] +" | "+ RB.wantsMem[3] + "| Sum: " + sum);
        }
    ...
    function progressbar_init() {
        ...
        //CUSTOM
        //IDE adding fourth line for sum production
        var cellText = $e("div", [["class", allIDs[2]]]);
        timerRB[4] = new Object();
        timerRB[4].pb = $e('div', [['class', allIDs[16] + 4]]);
        var fval = $e('DIV');
        var sumIncomeOfCurrentVillage = income[0] + income[1] + income[2] + income[3];
        fval.appendChild(trImg('r' + (3+1),sumIncomeOfCurrentVillage));
        timerRB[4].pval = $e('span',[['style','padding:0px 4px;']]);
        fval.appendChild(timerRB[4].pval);


        timerRB[4].time = 0;
        timerRB[4].val = $ee('span', 'Sum production:' +sumIncomeOfCurrentVillage);

        fval.appendChild(timerRB[4].val);

        timerRB[4].pb.appendChild(fval);
        cellText.appendChild(timerRB[4].pb);

        var row = $ee('TR', $c(cellText));


         var sumAttr = [['class',allIDs[11]]];
        if( RB.Setup[22] > 0 ) {
            if( j == mm[0] ) sumAttr.push(['style','color:green;']);
            if( j == mm[1] ) sumAttr.push(['style','color:red;']);
        }
        row.appendChild($c(ssPPH,sumAttr));
        tblBody.appendChild(row);

        //CUSTOM
         //IDE adding fifth line for sum actual resource
         var cellText = $e("div", [["class", allIDs[2]]]);
         timerRB[5] = new Object();
         timerRB[5].pb = $e('div', [['class', allIDs[16] + 5]]);
         var fval = $e('DIV');
         fval.appendChild(trImg('r' + (3+1),income[3]));
         timerRB[5].pval = $e('span',[['style','padding:0px 4px;']]);
         fval.appendChild(timerRB[5].pval);


         var sumCurrentRes = resNow[0] + resNow[1] + resNow[2] + resNow[3];
         timerRB[5].time = 0;
         timerRB[5].val = $ee('span', 'Current sum resource: '+sumCurrentRes);

         fval.appendChild(timerRB[5].val);

         timerRB[5].pb.appendChild(fval);
         cellText.appendChild(timerRB[5].pb);
    ...
    function overviewAll () {
        ...
        var menuD = $em('TD',[linkOW,' | ',linkOR,' | ',linkOT],[['style','text-align:'+docDir[0]+';']]);
    ...
    function viewMessageIWDisplay( aLink, tV, xy ) {
        ...
        var viewPref = [
            ...
            ['.//*[@id="report_surround"]','reports','padding-top:10px;padding-'+docDir[0]+':25px;']];
                ...
                if( neFL ) {
                    if ( mapFL == true ) {
                        ...
                        newT.appendChild($em('TR',[
                            $c((typeof aCCs[i][3].uid != "undefined" ? $em('A',[aCCs[i][0],(aCCs[i][3].v<8?$e('img',[['src','img/x.gif'],['class','nation nation'+aCCs[i][3].v],['style','float:none;'+((aCCs[i][3].v)==5?'background-position: 0 -78px;':'')]]):"")],[['href','spieler.php?uid='+aCCs[i][3].uid[0]]]):"")),
    ...
    function analyzerBattle () {
        ...
        var attakerN = $gc('role',tt[0].rows[0].cells[0])[0].innerHTML;
        var defenderN = $gc('role',tt[1].rows[0].cells[0])[0].innerHTML;
    ...
    function detectAttack () {
        ...
        function findAttackFS() {
            ...
            ajaxRequest(aLink, 'GET', null, function(ajaxResp) {
                var ad = ajaxNDIV(ajaxResp);
                var move = $xf('.//*[@class="attack"]','f',ad);
                ad = null;
                if (move) {
                    var att = $gt('a',move.parentNode);
                    var pat = new RegExp('spieler.php?uid=' + userID);
    ...
    [650,670,650,240,1,0],
    [830,860,830,305,1,0],
    [1065,1100,1065,395,1,0],
    [1365,1405,1365,505,1,0],
    [1745,1800,1745,645,1,0],
    [2235,2300,2235,825,1,0],
    [2860,2945,2860,1055,1,0],
    [3660,3770,3660,1350,1,0],
    [4685,4830,4685,1730,1,0],
    [5995,6180,5995,2215,1,0],//10
    [7675,7910,7675,2835,2,0],
    [9825,10125,9825,3625,2,0],
    [12575,12960,12575,4640,2,0],
    [16095,16590,16095,5940,2,0],
    [20600,21235,20600,7605,2,0],
    [26365,27180,26365,9735,2,0],
    [33750,34790,33750,12460,2,0],
    [43200,44530,43200,15950,2,0],
    [55295,56995,55295,20415,2,0],
    [70780,72955,70780,26135,2,0]//20
    ]
    ];
    ...
    function villageBMover () {
        ...
        var levels = $xf('./DIV','l',$g('levels'));
        var levelsRef = [];
        for( i=0; i<levels.snapshotLength; i++)
            levelsRef[levels.snapshotItem(i).getAttribute('class').match(/\d+/)[0]-19]=i;
        if( RB.vBM[0] > 0 ) {
            ...
            for( i=0; i<RB.vBM[0]; i++)	{
                ...
                if( typeof(levelsRef[t]) != 'undefined' )
                    levels.snapshotItem(levelsRef[t]).setAttribute('style','left:'+(xy[1]+(ltr?20:-35))+'px; top:'+(xy[2]+10)+'px;');
            }
        }
    ...
    function displayWhatIsNew () {
        if ($g('whatsnew')) {
            ...
            content.innerHTML = "What's new in Version "+version+" - Feb 11, 2018:<p></p><ui><li>Oasis info: Added consumed crop back</li></ui>";
