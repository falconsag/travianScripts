...
(function () {
    ...
    var langs = ['auto','English (en)','???? (ar)','????????? (bg)','Bosanski (bs)','Deutsch (de)','???????? (el)','Espanol (es)','????? (fa)','Fran�ais (fr)','Hrvatski (hr)','Magyar (hu)','Italiano (it)','Nederlands (nl)','Polski (pl)','Portugues (pt)','Rom�n� (ro)','??????? (ru)','?????? (sr)','Svenska (sv)','T�rk�e (tr)','?????????? (ua)','Ti?ng Vi?t (vi)','?? (zh)'];
    ...
    DICT = {
     ...
     ar: { // Arabic, thx ww_start_t
        ...
        fr: { // French translation , thx azukae09
            ...
            notes : "notes",
            res90 : "Ressources a % de la capacit�",
            refresh : "rafraichir",
            warehouse : "Entrep�t",
            ...
            adetecth : "Fait des requetes masqu�es au serveur, ce qui viole les regles et peut ocasionner une sanction",
        ...
        pt: { // Portuguese language, thx Kendra
            ...
            builtinh : 'Para equilibrar a produ�ao: a cor Vermelha - recursos que mais precisam; Verde - recursos que menos precisam',
            normalize : 'Equilibrar a produ�ao',
            normal : "normal",
            ...
            adetecth : "Esta op�ao utiliza a�oes ocultas no servidor, violando as regras. Poder� levar a puni�ao do jogo.",
            adetectt : "periodo de detectar ataques",
            buildhint : "Dicas de Constru�ao",
            onallp : "Todas as p�ginas",
            buildand : "Mostrar constru�ao em contagem regressiva e atacar",
            ...
            bidinch : 'S� disponivel para a versao Travian 4',
            ...
            incomres : "informa�oes de recursos recebidos",
            incomreso : ['desligado','ligado','com sum�rio','Modo WW'],
            troopsI : "Informa�oes sobre as tropas",
            troopsIo : ['Desligado','Ligado','Actualizado'],
            defRP : "A�ao pr�-definida no envio de tropas",
            showls : "Mostrar links",
            showAsSN : "Usar links como segundo nome",
            showlso : ['desligado','ligado','na janela'],
            savedls : "Links salvos",
            savedd : "Salvar dados",
            saveddh : 'incluindo links e segundo nome. Se uma conta exclu�da, ou nao o seu computador.',
            ...
            youlang : "Seu idioma",
            notifi : "Notifica�oes",
            notification : "notifica�ao ap�s a constru�ao",
            method : "M�todo",
            audiourl : "Link do ficheiro de audio",
            audiotest : "Testar Audio",
            colorCustomize : "Op�oes de Cores",
            colorHint : "Deixe em branco para a cor padrao",
            color0 : "Pronto para evoluir",
            color1 : "Evoluir fazendo NPC",
            color2 : "Nao � poss�vel evoluir <br/>(Falta de recursos)",
            color3 : "Nao � poss�vel evoluir <br/>(Nao tem armazem e/ou celeiro suficiente)",
        ...
        sv:{ // Swedish translation, thx Dragon from the future
            ...
            builtinh : "F�r att aterst�lla produktionen: r�d f�rg - Beh�vs mest resurser, green - beh�vs mindre resurser",
            normalize : "Aterst�ll produktionen",
            normal : "normal",
            ...
            sendres : "Visa &laquo;s�nd ravaror/trupper&raquo; ikoner",
            ...
            resbar : "Ravaror-f�lt",
            showres : "Visa ravaror-f�ltet i ett eget f�nster",
            redbl : "r�d (i timmar)",
            ...
            incomreso : ['av','pa','med sammanfattning','V�rldsunder'],
            troppsl : "Information om soldaterna",
            troopslo : ['av','pa','i f�nster'],
            defRP : "F�rvald attacktyp pa samlingsplats",
            showls : "Visa l�nkar",
            showlso : ['av','pa','i f�nster'],
            ...
            savedelallh : '�r du s�ker pa att du vill radera all data, l�nkar och andra namnpa byar?',
        ...
        tr: { // Turkish language. xpugur
            ...
            consnegat : "Bu k�yde t�ketim eksilerde. Ka� dakika gerekiyor rezervlerin dolmasi i�in?",
            bmove : "Binalari ta�i",
            // settings
            none : "Yok",
            auto : "otomatik",
            ...
            cranny : "siginak sari seviyesi (y�zde)",
            crannyh : 'normal 80, klasik veya eser yagmasi i�in 70 ',
            builtin : "Entegre ara�lar",
            builtinh : '�retimi normalle�tirmek i�in: kirmizi renk - en gerekli kaynak, ye�il - en az gerekli kaynak',
            ...
            buildhint : "in�aat ipu�lari",
            onallp : "T�m sayfalar",
            buildand : "in�aat gerisayimini ve saldirilari g�ster",
            ...
            bidinch : 'travian4 a�ik-arttirmalari i�in',
            show3x : "yanli� veri g�sterebilir",
            show3xh : '3x ve 2x ile g�nderilen kaynak aki�ini tahmin etmeye �ali�',
            ...
            troopsIo : ['kapa','a�','yardim ara'],
            defRP : "git-gel noktasi i�in standart hareket",
            showls : "Baglantialri g�ster",
            showAsSN : "Baglantilari ikinci isim olarak kullan",
            showlso : ['kapa','a�','pencerede'],
            savedls : "kaydedilmi� baglantilar",
            savedd : "kaydedilmi� veriler",
            saveddh : 'baglantilar ve ikinci ismi i�eren. Hesap silindiyse, yada kendi bilgisayariniz degilse.',
            savedelall : "kaydedilmi� t�m verileri sil",
            savedelallh : 'ikinci isim ve baglantilari i�eren, t�m verileri silmekte emin misiniz?',
            scrlang : "Kod dili",
        ...
        vi: { // VietNamese translation by Nguy?n Duy Thanh
            ...
            consnegat : "M?c tieu th? �m. C?n bao nhieu ph�t �? d? tr??",
            bmove : "D?i c�ng trinh",
            // settings
            none : "Kh�ng",
            auto : "t? �?ng",
            info : "Th�ng tin",
            ...
            racelist : ['Romans','Teutons','Gauls','Nature','Natars','Egyptians','Huns','detect'],
            cranny : "B�o mau vang khi ?ng tai nguyen �?t (%)",
            crannyh : 'th�ng thu?ng la 80, 70 cho lang binh thu?ng ho?c lang c� Binh ru?u c?a Dionysus',
            builtin : "C�ng c? c�ng trinh",
            builtinh : 'Chu?n ho� s?n lu?ng tai nguyen: mau �? -lo?i tai nguyen c?n nh?t, mau xanh - lo?i tai nguyen �t c?n',
            normalize : 'Chu?n ho� s?n lu?ng tai nguyen',
            normal : "chu?n",
            banalyze : "Ch?c n�ng - ph�n t�ch tr?n chi?n",
            cropfind : "Ch?c n�ng - tim lang nhi?u ru?ng l�a",
            adetect : "Ph�t hi?n t?n c�ng",
            adetecto : ['t?t','w/o m?c �?nh','m?'],
            adetecth : "?n c�c hanh vi c� th? d?n �?n hinh ph�t",
            adetectt : "Th?i gian ph�t hi?n t?n c�ng",
            buildhint : "M?o x�y d?ng",
            onallp : "T?t c? trang",
            buildand : "Hi?n th? th?i gian x�y d?ng va t?n c�ng",
            buildandh : 'Trong danh s�ch lang',
            sendres : "Hi?n bi?u tu?ng �G?i tai nguyen/G?i l�nh�",
            sendmess : "Hi?n bi?u tu?ng <<g?i>>",
            analyzer : "Ph�n t�ch th? gi?i",
            bigicon : "Hi?n bi?u tu?ng Binh tru?ng",
            addvtable : "Hi?n th? danh s�ch lang b? sung",
            addvtableo : ['t?t','m?','d�nh'],
            opennote : "T? �?ng m? ghi ch�",
            notesize : "K�ch thu?c c?a s? ghi ch�",
            openoview : "T? �?ng m? t?ng qu�t lang",
            ...
            npcsumh : 'ch? va c�ng trinh',
            bidinc : "T�ng �?u gi�",
            bidinch : '�?u gi� c?a travian4',
            show3x : "C� th? hi?n th? d? l?u kh�ng ch�nh x�c",
            show3xh : 'c? g?n d? �o�n c�c lu?n tai nguyen sever 2x va 3x �ang g?i',
            rpandmp : "Binh tru?ng va ch?",
            incomres : "Th�ng tin tai nguyen �ang �?n",
            incomreso : ['t?t','m?','v?i t�m t?t','ch? �? WW'],
            troopsI : "Th�ng tin v? qu�n �?i",
            troopsIo : ['t?t','m?','tim tr? gi�p'],
            defRP : "Hanh �?ng m?t �?nh khi g?i l�nh",
            showls : "Hi?n lien k?t",
            showAsSN : "S? d?ng lien k?t nhu ten ph?",
            showlso : ['t?t','m?','trong c?a s?'],
            savedls : "Luu lien k?t",
            savedd : "Lien k?t �a luu",
            saveddh : 'g?m lien k?t va lien k?t ph?. N?u tai kho?ng xo� ho?c ��y kh�ng ph?i m�y t�nh c?a b?n.',
            savedelall : "xo� t?t c? d? li?u �a luu",
            savedelallh : 'b?n c� ch?c mu?n xo� h?t d? li?u, bao g?m c? lien k?t va ten ph? cu? n�?',
            ...
            audiotest : "Th? nh?c",
            neighbors : "Tim ki?m",
            colorCustomize : "Cai �?t mau s?c",
            colorHint : "�? tr?ng �? cho mau m?c �?nh",
            color0 : " S?n san n�n c?p ",
            color1 : "N�n c?p th�ng qua NPC",
            color2 : "Kh�ng th? n�n c?p<br>(do kh�ng �? tai nguyen)",
            color3 : "kh�ng th? n�n c?p<br>(do nha kho/ kho l�a kh�ng �? s?c ch?a)",
            color4 : "Hoan thanh n�n c?p"
        },
    ...
    function calcTroopCost () {
        function resRecalc () {
            ...
            var nc = 0;
            //wRes:
            //[input.text, "t1", 103, 120, 100, 150, 30, 1]
            //_ , _ , 1 egység gyártási idő, fa, agyag, vas, búza, búzafogy
            for( var i=0; i < wRes.length; i++ ) {
                nc = parseInt(wRes[i][0].value).NaN0();
                for( var t=0; t<6; t++ ) allWR[t] += wRes[i][t+2] * nc;
            }
            //nc értéke, hogy hányat ütöttél be egységet gyártani
            //allWR megszorozva a beütött számmal
            //wantD = mennyi nyersanyag kell hozzá
